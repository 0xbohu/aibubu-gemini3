...
export default function AssessmentPage() {
  ...
  const confirmLevel = async (level: string) => {
    ...
    try {
      ...
      // Navigate to tutorials page with speaking category and selected language
      router.push(`/tutorials?category=speaking&language=${language.language_code}`)
    } catch (error) {
      ...
      <main className="max-w-6xl mx-auto p-4 sm:p-6">
        ...
        {step === 1 && (
          <div className="space-y-8">
            ...
            {/* Only show speaking test for English */}
            {language?.language_code === 'en' ? (
              ...
              /* For non-English languages, only show manual selection */
              <div className="max-w-2xl mx-auto">
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">Select the level that best matches your proficiency</p>
                    <KidBadge color="blue">
                      <Star className="w-3 h-3 mr-1" />
                      Quick & Easy
                    </KidBadge>
